...
from parameters_metabolism_miRNA_noWO import *
...
DSargs.pars={ 'ga':ga,'ka':ka,'A0aa':A0aa,'A0ah':A0ah,'A0aR':A0aR,'A0rn':A0rn,'A0rm':A0rm,
		'lambdaaa':lambdaaa,'lambdaah':lambdaah,'lambdaar':lambdaar,'y':6.,'g2':g2,
...
## cancer
DSargs.ics={'A':150,'mh':400,'h':266,'Rmt':15,'Rnox':15}
DSargs.xdomain= {'A':[0,500],'h':[0,500],'mh':[0,500],'Rmt':[0,150],'Rnox':[0,50]}
...
new_domains= {'A':[0,500],'h':[0,500],'mh':[0,500],'Rmt':[0,150],'Rnox':[0,50]}
...
with open("data_metabolism_nullcline_miRNA_noWO.json",'w') as outfile:
