...
DSargsF.pars = {	'gz':gz, 'u0':u0,'nu':nu,'kz':kz,
		...
		'lamdaSu3':lamdaSu3, 'ku3':ku3, 'gs':gs, 'ks':ks, 'lamdaAs':0.4, 'nAs':2., 'A0s':100. ,'A':300 ,'h':300}
...
DSargsF.varspecs = { 'u':'gu*H(Z(mz,u,u0,nu,kz,gz),Z0u,nzu,lamdazu)*H(S,S0u,nsu,lamdaSu)*H(h,1,1,1)*H(A,1,1,1)-mz*Yu(u,u0,nu)-ku*u',
		   ...
		   'ms':'gms*H(h,1,1,1)*H(S,S0ms,nsms,lamdaSms)*H(A,A0s,nAs,lamdaAs)-ms*Ym3(u3,u30,nu3)-kms*ms',
...
if myrank==0:
	...
	plt.savefig("EM_AS_hmz.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==1:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_AS_hs.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==2:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_AS_hu.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==3:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_AS_hms.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==4:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_AS_hu3.png",bbox_inches='tight')
	#plt.show()
	plt.close()
