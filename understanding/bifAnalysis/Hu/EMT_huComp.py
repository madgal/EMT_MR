...
DSargsF.pars = {	'gz':gz, 'u0':u0,'nu':nu,'kz':kz,
		...
		'lamdaSu3':lamdaSu3, 'ku3':ku3, 'gs':gs, 'ks':ks, 'lamdahu':1.5, 'nhu':1., 'h0hu':200. ,'h':300 }
	
DSargsF.varspecs = { 'u':'gu*H(Z(mz,u,u0,nu,kz,gz),Z0u,nzu,lamdazu)*H(S,S0u,nsu,lamdaSu)*H(h,h0hu,nhu,lamdahu)-mz*Yu(u,u0,nu)-ku*u',
...
DSargsF.xdomain = {'u':[0,200000],'mz':[0,200000],'S':[0,600000],'ms':[0,200000],'u3':[0,200000]}
...
##############
def plotCC(x,y):
	cl= ['b','k','r','g','m','y','orange']
	el= [1.,1.5,2.,4.,6.]
	ll,labs=[],[]
	minv,maxv=1000000,0
	for i in range(len(el)):
		DSargsF.pars['lamdahu']=el[i]
...
if myrank==0:
	...
	plt.savefig("EM_HU_hmz.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==1:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_HU_hs.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==2:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_HU_hu.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==3:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_HU_hms.png",bbox_inches='tight')
	#plt.show()
	plt.close()
...
if myrank==4:
	...
	plt.legend(ll,labs,fontsize=20,frameon=False,bbox_to_anchor=(1.04,1))
	plt.savefig("EM_HU_hu3.png",bbox_inches='tight')
	#plt.show()
	plt.close()
