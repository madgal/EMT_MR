	       ...
	       for(int d=1;d<2;d++){//HS set=1 for nothing
	         for(int e=10;e<11;e++){//Hu set=10 for nothing
	           for(int f=10;f<11;f++){//u3m set=10 for nothing
				...
				strcpy(finame,"EMT_MR_comp_");
				strcpy(frname,"EMT_MR_comp_");
				std::string s = std::to_string(i);
				strcat(finame,s.c_str());
				strcat(frname,s.c_str());
				srand(seeds[my_rank+i*comm_sz+10]);
				...
				strcat(finame,s.c_str());
				strcat(frname,s.c_str());
				srand(seeds[my_rank+i*comm_sz+20]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
				...
				strcat(finame,s.c_str());
				strcat(frname,s.c_str());
				srand(seeds[my_rank+i*comm_sz+30]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
				...
				strcat(finame,s.c_str());
				strcat(frname,s.c_str());
				srand(seeds[my_rank+i*comm_sz+40]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
	}}}}}}}}}//a
