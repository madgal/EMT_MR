...
double lamdazu3 = 0.2;
double lamdaSu3 = 0.1;
double lamdaZm=7.5	;///Different than original coupled value
double lamdaSm=10.	;
	    ...
	    for(int g=1;g<4;g++){//u3n set=10 for nothing
	      for(int h=3;h<8;h++){//input set=5 for nothing
	        for(int i=0;i<3;i++){//uh
                ...
                strcpy(finame,"EMT_MR10_HS_1_1_Au_1_1_AZ_0_95_AS_0_95_");
                strcpy(frname,"EMT_MR10_HS_1_1_Au_1_1_AZ_0_95_AS_0_95_");
