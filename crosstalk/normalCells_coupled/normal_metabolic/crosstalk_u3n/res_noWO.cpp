...
std::string get3nParameters(int i,int j){
    std::string tmp_return="_u3n_0_";
    std::string s;
	lamda3n=i*0.1+j*0.01;
	s = std::to_string(i);
	tmp_return+=s.c_str();
	s = std::to_string(j);
	tmp_return+=s.c_str();
	       ...
	       for(int d=1;d<2;d++){//HS set=1 for nothing
	         for(int e=10;e<11;e++){//Hu set=10 for nothing
	           for(int f=10;f<11;f++){//u3m set=10 for nothing
	             for(int g=0;g<10;g++){//u3n set=10 for nothing
	             for(int g2=1;g2<10;g2++){//u3n set=10 for nothing2
