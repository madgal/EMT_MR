...
double uF(double u,double mz,double Z,double ms,double u3,double S,double A,double Rmt,double Rnox,double h,double mh){
	return gu*H(Z,Z0u,nzu,lamdazu)*H(S,S0u,nsu,lamdaSu)*H(h,h0u,nhu,lamdahu)*H(A,A0u,nAu,lamdaAu)-mz*Yu(u,u0,nu,yui)-ku*u;}
double mzF(double u,double mz,double Z,double ms,double u3,double S,double A,double Rmt,double Rnox,double h,double mh){
 	   ...
 	   for(int b=1;b<2;b++){//Au set=1 for nothing
	     for(int c=10;c<11;c++){//AZ set=10 for nothing
	       for(int d=1;d<2;d++){//HS set=1 for nothing
	         for(int e=10;e<11;e++){//Hu set=10 for nothing
	           for(int f=10;f<11;f++){//u3m set=10 for nothing
				...
				//runSimulation(finame,frname,1000,my_rank,comm_sz);
			        ...
			        strcpy(finame,"EMT_MR_kh4");
			        strcpy(frname,"EMT_MR_kh4");
				kh = 0.4;
				srand(seeds[my_rank]);
				//runSimulation(finame,frname,1000,my_rank,comm_sz);
			        
				strcpy(finame,"EMT_MR_kh35_y8");
			        strcpy(frname,"EMT_MR_kh35_y8");
				kh = 0.35;
				y=8;
				srand(seeds[my_rank]);
				//runSimulation(finame,frname,1000,my_rank,comm_sz);
			        
				strcpy(finame,"EMT_MR_kh35_y6");
			        strcpy(frname,"EMT_MR_kh35_y6");
				kh = 0.35;
				y=6;
				srand(seeds[my_rank]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
			        
				strcpy(finame,"EMT_MR_kh4_y5");
			        strcpy(frname,"EMT_MR_kh4_y5");
				kh = 0.4;
				y=5;
				srand(seeds[my_rank]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
			        
				strcpy(finame,"EMT_MR_kh4_y4");
			        strcpy(frname,"EMT_MR_kh4_y4");
				kh = 0.4;
				y=4;
				srand(seeds[my_rank]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
			        
				strcpy(finame,"EMT_MR_kh35_y4");
			        strcpy(frname,"EMT_MR_kh35_y4");
				kh = 0.35;
				y=4;
				srand(seeds[my_rank]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
			        
				strcpy(finame,"EMT_MR_kh35_y5");
			        strcpy(frname,"EMT_MR_kh35_y5");
				kh = 0.35;
				y=5;
				srand(seeds[my_rank]);
				runSimulation(finame,frname,1000,my_rank,comm_sz);
