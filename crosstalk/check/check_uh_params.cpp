...
int  main(void){
	...
	/*
	/// EMT params set 1
	strcpy(finame,"EMT_MR_lamdauH_set1_");
	strcpy(frname,"EMT_MR_lamdauH_set1_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 2
	strcpy(finame,"EMT_MR_lamdauH_set2_");
	strcpy(frname,"EMT_MR_lamdauH_set2_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 3
	strcpy(finame,"EMT_MR_lamdauH_set3_");
	strcpy(frname,"EMT_MR_lamdauH_set3_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 4
	strcpy(finame,"EMT_MR_lamdauH_set4_");
	strcpy(frname,"EMT_MR_lamdauH_set4_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 5
	strcpy(finame,"EMT_MR_lamdauH_set5_");
	strcpy(frname,"EMT_MR_lamdauH_set5_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 6
	strcpy(finame,"EMT_MR_lamdauH_set6_");
	strcpy(frname,"EMT_MR_lamdauH_set6_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 7
	strcpy(finame,"EMT_MR_lamdauH_set7_");
	strcpy(frname,"EMT_MR_lamdauH_set7_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 8
	strcpy(finame,"EMT_MR_lamdauH_set8_");
	strcpy(frname,"EMT_MR_lamdauH_set8_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	*/
	...
	/// EMT params set 9
	strcpy(finame,"EMT_MR_lamdauH_set9_");
	strcpy(frname,"EMT_MR_lamdauH_set9_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
	...
	/// EMT params set 10
	strcpy(finame,"EMT_MR_lamdauH_set10_");
	strcpy(frname,"EMT_MR_lamdauH_set10_");
	lih[0]=1.;
	lih[1]=1.;
	lih[2]=1.;
	ymih[0]=0.;
