...
int  main(void){
	...
	yuih[2]=0.009;
        ...
        for (int i=0; i<11;i++){//lamdaAm
		for (int j=0; j<11;j++){// lamda3m

				strcpy(finame,"EMT_MR10_input_20000_AS_0_95_Au_1_1_HS_1_1_Hu_0_1_u3n_0_2_uh_310");
				strcpy(frname,"EMT_MR10_input_20000_AS_0_95_Au_1_1_HS_1_1_Hu_0_1_u3n_0_2_uh_310");
				std::string s;
	...
	for(int i=0; i<4;i++){// input
	    for (int j=0; j<5;j++){// lamda3m
	        for (int k=1; k<4;k++){//lamda3n
	            for (int ii=0; ii<3;ii++){//lamdahu
	                for (int jj=0; jj<3;jj++){// uh
