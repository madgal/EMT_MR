...
int  main(void){
	...
	for(int a=0;a<10;a++){//AS set=10 for nothing
 	   for(int b=2;b<10;b++){//Au set=1 for nothing
	     for(int c=0;c<10;c++){//AZ set=10 for nothing
	       for(int d=2;d<10;d++){//HS set=1 for nothing
	         for(int e=0;e<10;e++){//Hu set=10 for nothing
	           for(int f=0;f<10;f++){//u3m set=10 for nothing
	             for(int g=0;g<10;g++){//u3n set=10 for nothing
	               for(int h=0;h<10;h++){//input set=5 for nothing
	                 for(int i=0;i<2;i++){//uh
			    if (i==0){
				        uhFlag=false;
