...
bioLevels getICS(){
	...
	bioLevels ics = {myrand()%u_range,myrand()%mz_range,myrand()%Z_range,myrand()%ms_range,myrand()%u3_range,myrand()%S_range,myrand()%A_range,myrand()%Rmt_range,myrand()%Rnox_range,myrand()%h_range,myrand()%mh_range};
	return ics;
}
