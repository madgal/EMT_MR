...
std::string getGParameters(int i,int j){
	std::string tmp_return="_grm_0_";
	std::string s;
	lgm = i*0.1;
 	   ...
 	   for(int b=1;b<2;b++){//Au set=1 for nothing
	     for(int c=10;c<11;c++){//AZ set=10 for nothing
	       for(int d=1;d<2;d++){//HS set=1 for nothing
	         for(int e=0;e<5;e++){//Hu set=10 for nothing
	           for(int f=0;f<11;f++){//u3m set=10 for nothing
	             for(int g=10;g<11;g++){//u3n set=10 for nothing
	               for(int h=0;h<2;h++){//input set=5 for nothing
	                for(int m=5;m<11;m++){// gm  set to 10 for nothing
	                 for(int n=10;n<11;n++){//gn  set to 10 for nothing
