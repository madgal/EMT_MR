...
int  main(void){
	...
	lgm=1.;
	/*
	strcpy(finame,"state_EM");
	strcpy(frname,"state_EM");

	str_cat=getAuParameters(1,0);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
	
	str_cat=getHSParameters(1,0);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
	...
	str_cat= getIParameters(10);

	str_cat=getAuParameters(1,0);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
	str_cat=getASParameters(10);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
	str_cat=getAZParameters(10);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
	
	str_cat=getHuParameters(5);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
	str_cat=getHSParameters(5,0);
	strcat(finame,str_cat.c_str());
	strcat(frname,str_cat.c_str());
