...
int  main(void){
	...
	for(int a=1;a<5;a++){//AS set=0 for nothing
 	   for(int b=0;b<1;b++){//Au set=0 for nothing
	     for(int c=0;c<1;c++){//AZ set=0 for nothing
	       for(int d=1;d<5;d++){//HS set=0 for nothing
	         for(int e=0;e<1;e++){//Hu set=0 for nothing
	           for(int f=1;f<4;f++){//u3m set=0 for nothing
	             for(int g=0;g<1;g++){//u3n set=0 for nothing
	               for(int h=0;h<1;h++){//input set=0 for nothing
