...
DSargsF.varspecs = {'u':'gu*H(Z(mz,u,u0,nu,kz,gz),Z0u,nzu,lamdazu)*H(S,S0u,nsu,lamdaSu)*H(h,h0u,nhu,lamdahu)*H(A,A0u,nAu,lamdaAu)*H(O,o0u,nou,lou)-mz*Yu(u,u0,nu)-mh*Yuh(0,u0,nuh)-ku*u',
		   ...
		   'ms':'gms*H(S,S0ms,nsms,lamdaSms)*H(I,I0m,nIm,lamdaIm)*H(h,h0ms,nhms,lamdahms)*H(A,A0ms,nAms,lamdaAms)*H(T,t0m,ntm,ltm)-ms*Ym(u3,u30,nu3)-kms*ms',
...
#plt.show()
fig.savefig("nullclines_figures/PSF_emt_nullcline.png",bbox_inches='tight')
plt.close()
