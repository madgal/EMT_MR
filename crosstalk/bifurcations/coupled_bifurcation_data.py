...
for lamI in range(len(lambdaVals[lamda])):
	...
	fileO = open("data_bif/fp_"+lamda+"_"+str(lambdaVals[lamda][lamI])+".txt",'w')
	...
	lp_cont=True
	i=1
	fileO = open("data_bif/LP_"+lamda+"_"+str(lambdaVals[lamda][lamI])+".txt",'w')
	...
	fileO = open("data_bif/bif_"+lamda+"_"+str(lambdaVals[lamda][lamI])+".txt",'w')
