...
##############3
##############3
def plotPhaseICS(ax,subF,titleStart,typeN,xlabel=None,xlim=None,ylabel=None,noICS=False,fs=None,legend=True):
    ##########
    if not fs:
        fs=20
...
def plotICS(ax,df,key,key1,key2,fs=20):
    ...
    xvals=xvals[inds]
    ax.set_xticks(np.arange(0,len(df1c)))
...
##############3
##############3
def plotNumberBreakdown(ax,df,maxRegType,pType,fs=20):
    ...
    if pType=='MR':
        ...
        ax.bar(0.7,df2b[emwo].values[xloc],color='tab:green',label='W/O',width=0.2)
        ax.bar(0.9,df2b[emo].values[xloc],color='tab:blue',label='W',width=0.2)
        ax.bar(1.1,df2b[emw].values[xloc],color='tab:orange',label='O',width=0.2)
        ax.bar(1.7,df2b[mwo].values[xloc],color='tab:green',width=0.2)
        ax.bar(1.9,df2b[mo].values[xloc],color='tab:blue',width=0.2)
        ax.bar(2.1,df2b[mw].values[xloc],color='tab:orange',width=0.2)
        ax.bar(2.7,df2b[ewo].values[xloc],color='tab:green',width=0.2)
        ax.bar(2.9,df2b[eo].values[xloc],color='tab:blue',width=0.2)
        ax.bar(3.1,df2b[ew].values[xloc],color='tab:orange',width=0.2)
        ax.set_xticks([1,2,3])
